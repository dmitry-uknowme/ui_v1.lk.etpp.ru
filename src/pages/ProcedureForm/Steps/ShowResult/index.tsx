...
const ShowResultModal: React.FC<ShowResultModalProps> = ({
  ...
  const [positionsTableData, setPositionsTableData] = useState(ormGlobalServerData?.positionsTableData?.length && !positionsTableData.length ? formGlobalServerData.positionsTableData : []);
