...
const Step5 = ({ currentStep, setCurrentStep, nextStep, prevStep }) => {
      ...
      if (organizations?.length) {
        if (!formValue.organizer_id?.trim()?.length) {
          ...
          setFormValue((state) => ({
            ...
            organizer_org_full_name: selectOrganizerOrganization.full_title_organization,
            organizer_org_short_name: selectOrganizerOrganization.short_title_organization,
        ...
        if (!formValue.customer_id?.trim()?.length) {
          ...
          setFormValue((state) => ({
            ...
            customer_org_full_name: selectCustomerOrganization.full_title_organization,
            customer_org_short_name: selectCustomerOrganization.short_title_organization,
  ...
  const handleSubmit = async () => {
    console.log('vallll', formValue)
    console.log('is eq', isOrganizerEqualsCustomer)
